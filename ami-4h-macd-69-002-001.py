...
coin17 = "MANA" # 디센트럴랜드 - 크라켄 상장, 그레이스케일 상장
...
while True:
    ...
    if now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21:
        if now.minute == 0:
            ...
            bpAve7 = bp61 + bp62 + bp63 + bp64 + bp65 + bp66 + bp67 + bp68 + bp69

            bpAve = (bpAve1 + bpAve2 + bpAve3 + bpAve4 + bpAve5 + bpAve6 + bpAve7 ) / 70
