...
coin10 = "LTC" # 라이트코인 - 크라켄 상장, 그레이스케일 상장
...
coin12 = "ALGO" # 알고랜드 - 크라켄 상장
coinMode12 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin13 = "BCH" # 비트코인캐시 - 크라켄 상장, 그레이스케일 상장
...
coin23 = "ETC" # 이더리움클래식 - 크라켄 상장, 그레이스케일 상장
...
while True:
    ...
    if now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21:
        if now.minute == 0:
            ...
            bpAve = (bpAve1 + bpAve2 + bpAve3 + bpAve4 + bpAve5 + bpAve6 + bpAve7 ) / 71
