...
def get_macd(ticker):
    ...
    e_ma12_9_1 = ( price_9 * ma12_sc ) + ( ( ma12_9 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_9 = ( price_9 * ma12_sc ) + ( ( e_ma12_9_1 + 1 ) * ( 1 - ma12_sc ) )

    e_ma12_8_1 = ( price_8 * ma12_sc ) + ( ( ma12_8 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_8 = ( price_8 * ma12_sc ) + ( ( e_ma12_8_1 + 1 ) * ( 1 - ma12_sc ) )

    e_ma12_7_1 = ( price_7 * ma12_sc ) + ( ( ma12_7 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_7 = ( price_7 * ma12_sc ) + ( ( e_ma12_7_1 + 1 ) * ( 1 - ma12_sc ) )

    e_ma12_6_1 = ( price_6 * ma12_sc ) + ( ( ma12_6 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_6 = ( price_6 * ma12_sc ) + ( ( e_ma12_6_1 + 1 ) * ( 1 - ma12_sc ) )

    e_ma12_5_1 = ( price_5 * ma12_sc ) + ( ( ma12_5 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_5 = ( price_5 * ma12_sc ) + ( ( e_ma12_5_1 + 1 ) * ( 1 - ma12_sc ) )

    e_ma12_4_1 = ( price_4 * ma12_sc ) + ( ( ma12_4 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_4 = ( price_4 * ma12_sc ) + ( ( e_ma12_4_1 + 1 ) * ( 1 - ma12_sc ) )

    e_ma12_3_1 = ( price_3 * ma12_sc ) + ( ( ma12_3 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_3 = ( price_3 * ma12_sc ) + ( ( e_ma12_3_1 + 1 ) * ( 1 - ma12_sc ) )

    e_ma12_2_1 = ( price_2 * ma12_sc ) + ( ( ma12_2 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_2 = ( price_2 * ma12_sc ) + ( ( e_ma12_2_1 + 1 ) * ( 1 - ma12_sc ) )

    e_ma12_1_1 = ( price_1 * ma12_sc ) + ( ( ma12_1 + 1 ) * ( 1 - ma12_sc ) )
    e_ma12_1 = ( price_1 * ma12_sc ) + ( ( e_ma12_1_1 + 1 ) * ( 1 - ma12_sc ) )
    ...
    e_ma26_9_1 = ( price_9 * ma26_sc ) + ( ( ma26_9 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_9 = ( price_9 * ma26_sc ) + ( ( e_ma26_9_1 + 1 ) * ( 1 - ma26_sc ) )

    e_ma26_8_1 = ( price_8 * ma26_sc ) + ( ( ma26_8 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_8 = ( price_8 * ma26_sc ) + ( ( e_ma26_8_1 + 1 ) * ( 1 - ma26_sc ) )

    e_ma26_7_1 = ( price_7 * ma26_sc ) + ( ( ma26_7 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_7 = ( price_7 * ma26_sc ) + ( ( e_ma26_7_1 + 1 ) * ( 1 - ma26_sc ) )

    e_ma26_6_1 = ( price_6 * ma26_sc ) + ( ( ma26_6 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_6 = ( price_6 * ma26_sc ) + ( ( e_ma26_6_1 + 1 ) * ( 1 - ma26_sc ) )

    e_ma26_5_1 = ( price_5 * ma26_sc ) + ( ( ma26_5 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_5 = ( price_5 * ma26_sc ) + ( ( e_ma26_5_1 + 1 ) * ( 1 - ma26_sc ) )

    e_ma26_4_1 = ( price_4 * ma26_sc ) + ( ( ma26_4 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_4 = ( price_4 * ma26_sc ) + ( ( e_ma26_4_1 + 1 ) * ( 1 - ma26_sc ) )

    e_ma26_3_1 = ( price_3 * ma26_sc ) + ( ( ma26_3 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_3 = ( price_3 * ma26_sc ) + ( ( e_ma26_3_1 + 1 ) * ( 1 - ma26_sc ) )

    e_ma26_2_1 = ( price_2 * ma26_sc ) + ( ( ma26_2 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_2 = ( price_2 * ma26_sc ) + ( ( e_ma26_2_1 + 1 ) * ( 1 - ma26_sc ) )

    e_ma26_1_1 = ( price_1 * ma26_sc ) + ( ( ma26_1 + 1 ) * ( 1 - ma26_sc ) )
    e_ma26_1 = ( price_1 * ma26_sc ) + ( ( e_ma26_1_1 + 1 ) * ( 1 - ma26_sc ) )
    ...
    # macd = 단기이평 - 장기이평
    macd_1 = e_ma12_1 - e_ma26_1
    macd_2 = e_ma12_2 - e_ma26_2
    macd_3 = e_ma12_3 - e_ma26_3
    macd_4 = e_ma12_4 - e_ma26_4
    macd_5 = e_ma12_5 - e_ma26_5
    macd_6 = e_ma12_6 - e_ma26_6
    macd_7 = e_ma12_7 - e_ma26_7
    macd_8 = e_ma12_8 - e_ma26_8
    macd_9 = e_ma12_9 - e_ma26_9
...
coin35 = "WAVES" # 웨이브 - 크라켄 상장  --------------- 매매유의 나오기 전
