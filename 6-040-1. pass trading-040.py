...
# 객체 생성
f = open("upbit_001.txt", 'r', encoding='UTF-8')
lines = f.readlines()
...
# 매수설정금액 가져오기
#buy_krw = lines[5].strip()


# 코인명 가져오기
coin1 = lines[9].strip()
coin2 = lines[11].strip()
coin3 = lines[13].strip()
coin4 = lines[15].strip()
coin5 = lines[17].strip()
coin6 = lines[19].strip()
coin7 = lines[21].strip()
coin8 = lines[23].strip()
coin9 = lines[25].strip()
coin10 = lines[27].strip()
coin11 = lines[29].strip()
coin12 = lines[31].strip()
coin13 = lines[33].strip()
coin14 = lines[35].strip()
coin15 = lines[37].strip()
coin16 = lines[39].strip()
coin17 = lines[41].strip()
coin18 = lines[43].strip()
coin19 = lines[45].strip()
coin20 = lines[47].strip()
coin21 = lines[49].strip()
coin22 = lines[51].strip()
coin23 = lines[53].strip()
coin24 = lines[55].strip()
coin25 = lines[57].strip()
coin26 = lines[59].strip()
coin27 = lines[61].strip()
coin28 = lines[63].strip()
coin29 = lines[65].strip()
coin30 = lines[67].strip()
coin31 = lines[69].strip()
coin32 = lines[71].strip()
coin33 = lines[73].strip()
coin34 = lines[75].strip()
coin35 = lines[77].strip()
coin36 = lines[79].strip()
coin37 = lines[81].strip()
coin38 = lines[83].strip()
coin39 = lines[85].strip()
coin40 = lines[87].strip()
f.close()
...
# 매수가능 평균가.
buy_krw = (total_sum1 + total_sum2 + total_sum3  + total_sum4) / (4 / 2)
