...
def get_macd(ticker):
    ...
    #signal_2 = ( macd_2 + macd_3 + macd_4 + macd_5 + macd_6 + macd_7 + macd_8 + macd_9 + macd_10 ) / 9

    # 최종값
    #sin_1 = macd_1 - signal_1
    #sin_2 = macd_2 - signal_2
    #if sin_2 < 0:
    #    macd = sin_1
...
while True:
    ...
    if now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21:
        if now.minute == 0:
            ...
            #total_sum4 = total_bp5 / 10
            # 매수가능 평균가.
            buy_krw = (total_sum1 + total_sum2 + total_sum3 + total_sum4) / 4
            #buy_krw = (total_sum1 + total_sum2 + total_sum3 + total_sum4 + total_sum5) / 5
