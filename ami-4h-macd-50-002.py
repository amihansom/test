...
coin9 = "LINK" # 체인링크 - 크라켄 상장, 그레이스케일 상장
...
coin12 = "XLM" # 스텔라루멘 - 크라켄 상장, 그레이스케일 상장
