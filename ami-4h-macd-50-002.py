...
coinMode11 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer11 = 4  # 매수비중

coin12 = "TRX" # 트론 - 크라켄 상장
coinMode12 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer12 = 4  # 매수비중

coin13 = "LTC" # 라이트코인 - 크라켄 상장, 그레이스케일 상장     <---------------------------------------------- 10배
coinMode13 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer13 = 4  # 매수비중

coin14 = "BCH" # 비트코인캐시 - 크라켄 상장, 그레이스케일 상장     <---------------------------------------------- 10배
...
coin22 = "MANA" # 디센트럴랜드 - 크라켄 상장, 그레이스케일 상장     <---------------------------------------------- 10배
coinMode22 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer22 = 3  # 매수비중

coin23 = "SAND" # 샌드박스 - 크라켄 상장     <---------------------------------------------- 10배
...
coin25 = "XTZ" # 테조스 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
...
coin27 = "AAVE" # 에이브 - 크라켄 상장, 그레이스케일 상장     <---------------------------------------------- 10배
coinMode27 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer27 = 3  # 매수비중

coin28 = "AXS" # 엑시인피니티 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
...
coin33 = "WAVES" # 웨이브 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
...
coin51 = "ENJ" # 엔진코인 - 크라켄 상장
coinMode51 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin52 = "TFUEL" # 쎄타퓨엘
coinMode52 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin53 = "XEM" # 넴
coinMode53 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin54 = "ICX" # 아이콘 - 크라켄 상장
coinMode54 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin55 = "BORA" # 보라
coinMode55 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능



coin56 = "1INCH" # 1인치네트워크 - 크라켄 상장
coinMode56 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin57 = "ANKR" # 앵커 - 크라켄 상장
coinMode57 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin58 = "BTG" # 비트코인골드
coinMode58 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin59 = "ZRX" # 제로엑스 - 크라켄 상장
coinMode59 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin60 = "IOST" # 아이오에스티
coinMode60 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
...
coin86 = "STRK" # 스트라이크
coin87 = "FCT2" # 피르마체인 - 김치코인 - 매억남차트 - 2022-03-31-목    <---------------------------------------------- 10배
coin88 = "ARDR" # 아더
coin89 = "MFT" # 메인프레임
coin90 = "TT" # 썬더토큰
