...
coin39 = "KNC" # 카이버네트워크 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
