...
coin16 = "ETC" # 이더리움클래식 - 크라켄 상장, 그레이스케일 상장
...
coin49 = "KNC" # 카이버네트워크 - 크라켄 상장 - 김치코인  ##### 개돼지기법 추천 ==========----------
coinMode49 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
#bpPer49 = 1  # 매수비중
bpPer49 = 5  # 매수비중

coin50 = "HUM" # 휴먼스케이프 - 김치코인  ##### 개돼지기법 추천 ==========----------
...
coin53 = "LTC" # 유의종목 - 라이트코인 - 크라켄 상장, 그레이스케일 상장
...
print(" -----=====          자동 매매 시작          =====----- ")
print("---------- ---------- ---------- ---------- ----------")
print("     api 코드 유효기간은 2023년 5월 24일까지입니다.")
print("")
...
while True:
    ...
    if now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21:
        if now.minute == 0:
            ...
            print()
            print("     api 코드 유효기간은 2023 년 5 월 24 일까지 입니다.")
            print("---------- ---------- ---------- ---------- ----------")
