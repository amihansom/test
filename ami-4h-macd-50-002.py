...
coin44 = "HUM" # 휴먼스케이프 - 김치코인    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
coinMode44 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer44 = 10  # 매수비중

coin45 = "SXP" # 스와이프    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
...
coin47 = "KNC" # 카이버네트워크 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
coinMode47 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer47 = 10  # 매수비중

coin48 = "SRM" # 세럼 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
...
coin59 = "JST" # 저스트 - 매억남차트 - 2022-03-30-수    <---------------------------------------------- 10배
coinMode59 = 3 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin60 = "FCT2" # 피르마체인 - 김치코인 - 매억남차트 - 2022-03-31-목    <---------------------------------------------- 10배
