...
coin21 = "ETC" # 이더리움클래식 - 크라켄 상장, 그레이스케일 상장  - = 10배
...
coin26 = "WAVES" # 웨이브 - 크라켄 상장    |||||||| 개돼지기법 추천 - = 10배
...
coin33 = "AAVE" # 에이브 - 크라켄 상장, 그레이스케일 상장
