...
coin22 = "WAVES" # 웨이브 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
...
coin37 = "BAT" # 베이직어텐션토큰 - 크라켄 상장, 그레이스케일    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
