...
coin19 = "ATOM" # 코스모스 - 크라켄 상장
coinMode19 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer19 = 4  # 매수비중

coin20 = "ETC" # 이더리움클래식 - 크라켄 상장, 그레이스케일 상장
...
coin47 = "KAVA" # 카바 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
