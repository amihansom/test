...
coin10 = "NEAR" # 니어프로토콜    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
coinMode10 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer10 = 5  # 매수비중



coin11 = "MATIC" # 폴리곤 - 크라켄 상장
...
coin16 = "LINK" # 체인링크 - 크라켄 상장, 그레이스케일 상장
...
coin19 = "ETC" # 이더리움클래식 - 크라켄 상장, 그레이스케일 상장
...
coin40 = "BAT" # 베이직어텐션토큰 - 크라켄 상장, 그레이스케일
...
coin42 = "KAVA" # 카바 - 크라켄 상장    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
...
coin49 = "HUM" # 휴먼스케이프 - 김치코인    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
coinMode49 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer49 = 1  # 매수비중

coin50 = "MTL" # 메탈    ----- |||||||| 개돼지기법 추천 <---------------------------------------------- 10배
...
coinMode51 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin52 = "SRM" # 세럼 - 크라켄 상장
coinMode52 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin53 = "HUNT" # 헌트
coinMode53 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin54 = "SXP" # 솔라
coinMode54 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin55 = "MBL" # 무비블록 - 김치코인
coinMode55 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능


#
coin56 = "JST" # 저스트
coinMode56 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin57 = "ANKR" # 앵커 - 크라켄 상장
coinMode57 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin58 = "BTG" # 비트코인골드
coinMode58 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin59 = "BORA" # 보라
coinMode59 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin60 = "IOST" # 아이오에스티
coinMode60 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
...
coin61 = "GMT" # 스테픈 - 5월 11일부터 자동매매 사용 가능
...
while True:
    ...
    if now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21:
        if now.minute == 0:
                    ...
                    if op_mode51 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp51 < buy_bpAve51: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw51 >= buy_krw_price51: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price51 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin51, buy_krw_price51 * buy_krw_Ave)
                                ...
                                if krw51 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin51, krw51 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd52 == 1 or macd52 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode52 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp52 < buy_bpAve52: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw52 >= buy_krw_price52: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price52 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin52, buy_krw_price52 * buy_krw_Ave)
                                ...
                                if krw52 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin52, krw52 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd53 == 1 or macd53 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode53 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp53 < buy_bpAve53: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw53 >= buy_krw_price53: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price53 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin53, buy_krw_price53 * buy_krw_Ave)
                                ...
                                if krw53 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin53, krw53 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd54 == 1 or macd54 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode54 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp54 < buy_bpAve54: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw54 >= buy_krw_price54: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price54 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin54, buy_krw_price54 * buy_krw_Ave)
                                ...
                                if krw54 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin54, krw54 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd55 == 1 or macd55 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode55 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp55 < buy_bpAve55: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw55 >= buy_krw_price55: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price55 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin55, buy_krw_price55 * buy_krw_Ave)
                                ...
                                if krw55 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin55, krw55 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd56 == 1 or macd56 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode56 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp56 < buy_bpAve56: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw56 >= buy_krw_price56: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price56 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin56, buy_krw_price56 * buy_krw_Ave)
                                ...
                                if krw56 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin56, krw56 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd57 == 1 or macd57 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode57 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp57 < buy_bpAve57: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw57 >= buy_krw_price57: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price57 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin57, buy_krw_price57 * buy_krw_Ave)
                                ...
                                if krw57 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin57, krw57 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd58 == 1 or macd58 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode58 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp58 < buy_bpAve58: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw58 >= buy_krw_price58: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price58 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin58, buy_krw_price58 * buy_krw_Ave)
                                ...
                                if krw58 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin58, krw58 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd59 == 1 or macd59 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode59 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp59 < buy_bpAve59: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw59 >= buy_krw_price59: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price59 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin59, buy_krw_price59 * buy_krw_Ave)
                                ...
                                if krw59 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin59, krw59 * buy_krw_Ave)
            ...
            # MACD 조건문
            if macd60 == 1 or macd60 == 3:     # macd가 골든크로스일때 매수
                # 매수가능금액 불러오기
                    ...
                    if op_mode60 == 2:   # 다음 코인 매매 가능유무  -  1 = 골든크로스 , 2 = 데드크로스
                        ...
                        if bp60 < buy_bpAve60: # 코인보유금액이 평균가보다 낮을때 매수시도
                            ...
                            if krw60 >= buy_krw_price60: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price60 >= lowPrice:    # 매수가능금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin60, buy_krw_price60 * buy_krw_Ave)
                                ...
                                if krw60 >= lowPrice:    # 보유금액이 최소주문가능금액인 lowPrice 보다 높을때 매수시도
                                    # 매수할 코인명, 매수할 코인금액
                                    upbit.buy_market_order(krw_coin60, krw60 * buy_krw_Ave)
