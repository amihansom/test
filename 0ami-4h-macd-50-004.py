...
# 흥효꺼
# 엑세스키, 시크릿키 가져오기
access = "b77IRfaE4YgWxAGLsSYHjrS2AzyzZtTRQwNnyunR"
secret = "fnB0toANVSmZuL7rGSzUUpWYIxUexiY94qp4dxpJ"

# 동생꺼
# 엑세스키, 시크릿키 가져오기
#access = "pKgslhsXO8Mlpc8mpxODDcW0FQq5dFj48fVzUv9w"
#secret = "7xWGvzy1CV1mmb3aPXRxwThWjXNGFDPAUxHeMhwx"
...
coin14 = "ETC" # 이더리움클래식 - 크라켄 상장, 그레이스케일 상장
...
coin43 = "ENJ" # 엔진코인 - 크라켄 상장
coinMode43 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer43 = 1  # 매수비중

coin44 = "BAT" # 베이직어텐션토큰 - 크라켄 상장, 그레이스케일
...
coin59 = "WAVES" # 웨이브 - 크라켄 상장
coinMode59 = 3 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin60 = "SC" # 시아코인 - 크라켄 상장
...
coin63 = "BORA" # 보라
coin64 = "ELF" # 엘프
coin65 = "STORJ" # 스토리지 - 크라켄 상장

coin66 = "LSK" # 리스크 - 크라켄 상장
coin67 = "PLA" # 플레이댑
coin68 = "MED" # 메디블록
coin69 = "PUNDIX" # 펀디엑스
