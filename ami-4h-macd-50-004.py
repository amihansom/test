...
coin36 = "1INCH" # 1인치네트워크 - 크라켄 상장
coinMode36 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
bpPer36 = 1   # 매수비중

coin37 = "BAT" # 베이직어텐션토큰 - 크라켄 상장, 그레이스케일
