...
# 코인명 가져오기
coin1 = "BTC" # 비트코인
coinMode1 = 2 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin2 = "ETH" # 이더리움
...
coin61 = "ONG" # 온톨로지가스
coinMode61 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin62 = "ELF" # 엘프
coinMode62 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin63 = "CVC" # 시빅
coinMode63 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin64 = "STMX" # 스톰엑스
coinMode64 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin65 = "SNT" # 스테이터스네트워크토큰
coinMode65 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능

coin66 = "HIVE" # 하이브
coinMode66 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin67 = "FCT2" # 피르마체인
coinMode67 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin68 = "MVL" # 엠블
coinMode68 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin69 = "DKA" # 디카르고
coinMode69 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin70 = "ARDR" # 아더
coinMode70 = 0 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
...
coin106 = "AAVE" # 에이브 - 2021-10-27 신규상장 11월 06일에 자동매매가능
coin107 = "1INCH" # 1인치네트워크 - 2021-10-27 신규상장 11월 06일에 자동매매가능
...
while True:
    ...
    if now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21:
        if now.minute == 0:
            ...
            total_bp1 = krw + bp7 + bp8 + bp9 + bp10
            ...
            buy_krw = (total_sum1 + total_sum2 + total_sum3 + total_sum4 + total_sum5) / 44
