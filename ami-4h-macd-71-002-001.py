...
# 거래량 동반한 5, 20일 이평선 조회.
#macd69 = get_acc_ma20(krw_coin69)
...
if macd69 >= 0:
    ...
    # 보유 및 매수 가능 출력.
    print(f"MACD = {macd69}  |  매수가능 - {op_mode69} - 매수불가-매도가능")
    print("")
else:
    # 다음 코인 매매 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
    op_mode69 = 3
    ...
    # 보유 및 매수 가능 출력.
    print(f"MACD = {macd69}  |  매수가능 - {op_mode69} - 매수가능-매도불가")
    print("")
...
# 거래량 동반한 5, 20일 이평선 조회.
#macd70 = get_acc_ma20(krw_coin70)
...
if macd70 >= 0:
    ...
    # 보유 및 매수 가능 출력.
    print(f"MACD = {macd70}  |  매수가능 - {op_mode70} - 매수불가-매도가능")
    print("")
else:
    # 다음 코인 매매 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
    op_mode70 = 3
    ...
    # 보유 및 매수 가능 출력.
    print(f"MACD = {macd70}  |  매수가능 - {op_mode70} - 매수가능-매도불가")
    print("")
...
# MACD 조회.
#macd71 = get_macd(krw_coin71)
# 거래량 동반한 MACD 조회.
macd71 = get_acc_macd(krw_coin71)
# 5, 20일 이평선 조회.
#macd71 = get_ma20(krw_coin71)
# 거래량 동반한 5, 20일 이평선 조회.
#macd71 = get_acc_ma20(krw_coin71)
...
if macd71 >= 0:
    ...
    # 보유 및 매수 가능 출력.
    print(f"MACD = {macd71}  |  매수가능 - {op_mode71} - 매수불가-매도가능")
    print("")
else:
    # 다음 코인 매매 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
    op_mode71 = 3
    ...
    # 보유 및 매수 가능 출력.
    print(f"MACD = {macd71}  |  매수가능 - {op_mode71} - 매수가능-매도불가")
    print("")
...
while True:
    ...
    if now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21:
        if now.minute == 0:
            ...
            # 코인별 금액 비율조정
            sell_bpAve69 = bpAve * bpPer69

            # MACD 조건문
            if macd69 < 0:     # macd가 0보다 작을때는 매도
                if coinMode69 == 1 or coinMode69 == 3:  # 0 = 매매중지 , 1 = >>>매도매수가능<<< , 2 = 매수만가능 , 3 = >>>매도만가능<<<
                    if op_mode69 == 1 or op_mode69 == 4:   # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                        print("")
                        print(f"[ 69. 매도시간 : {now}  |  코인명 : {coin69}  |  현재가 = ￦{price69}  |  MACD = ￦{macd69}  |  보유수량 = {krw_balance69}  |  평가금액 = ￦{bp69}  ||  매도평균금액 = ￦{sell_bpAve69} ]")

                        if bp69 > sell_bpAve69: # 보유금액이 평균가보다 높을때
                            # 매도할 코인 금액 = 코인보유금액 - 평균가
                            sell_krw_price69 = bp69 - sell_bpAve69

                            if sell_krw_price69 >= 10000:    # 매도할 금액이 ￦10,000 보다 높을때 매도
                                # 매도할 코인 갯수 = 매도할 코인 금액 - 현재가
                                sell_krw_balance69 = sell_krw_price69 / price69

                                # 보유코인 초과금액 매도시도
                                # 매도할 코인명 - krw_coin69, 매도할 코인수량 - sell_krw_balance69
                                upbit.sell_market_order(krw_coin69, sell_krw_balance69)

                                # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                op_mode69 = 2

                                print("평균 이상 금액 매도")
                                print(f"매도한금액 = ￦{sell_krw_price69}  |  매도한수량 = {sell_krw_balance69}  |  매수가능여부 - {op_mode69} - 매수가능-매도불가")
                                print("")
                            else:
                                # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                op_mode69 = 2
                                ...
                                print("￦10,000 이하 금액 매도불가")
                                print(f"매수가능여부 - {op_mode69} - 매수가능-매도불가")
                                print("")
            ...
            # 코인별 금액 비율조정
            sell_bpAve70 = bpAve * bpPer70

            # MACD 조건문
            if macd70 < 0:     # macd가 0보다 작을때는 매도
                if coinMode70 == 1 or coinMode70 == 3:  # 0 = 매매중지 , 1 = >>>매도매수가능<<< , 2 = 매수만가능 , 3 = >>>매도만가능<<<
                    if op_mode70 == 1 or op_mode70 == 4:   # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                        print("")
                        print(f"[ 70. 매도시간 : {now}  |  코인명 : {coin70}  |  현재가 = ￦{price70}  |  MACD = ￦{macd70}  |  보유수량 = {krw_balance70}  |  평가금액 = ￦{bp70}  ||  매도평균금액 = ￦{sell_bpAve70} ]")

                        if bp70 > sell_bpAve70: # 보유금액이 평균가보다 높을때
                            # 매도할 코인 금액 = 코인보유금액 - 평균가
                            sell_krw_price70 = bp70 - sell_bpAve70

                            if sell_krw_price70 >= 10000:    # 매도할 금액이 ￦10,000 보다 높을때 매도
                                # 매도할 코인 갯수 = 매도할 코인 금액 - 현재가
                                sell_krw_balance70 = sell_krw_price70 / price70

                                # 보유코인 초과금액 매도시도
                                # 매도할 코인명 - krw_coin70, 매도할 코인수량 - sell_krw_balance70
                                upbit.sell_market_order(krw_coin70, sell_krw_balance70)

                                # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                op_mode70 = 2

                                print("평균 이상 금액 매도")
                                print(f"매도한금액 = ￦{sell_krw_price70}  |  매도한수량 = {sell_krw_balance70}  |  매수가능여부 - {op_mode70} - 매수가능-매도불가")
                                print("")
                            else:
                                # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                op_mode70 = 2
                                ...
                                print("￦10,000 이하 금액 매도불가")
                                print(f"매수가능여부 - {op_mode70} - 매수가능-매도불가")
                                print("")
            ...
            # 코인별 금액 비율조정
            sell_bpAve71 = bpAve * bpPer71

            # MACD 조건문
            if macd71 < 0:     # macd가 0보다 작을때는 매도
                if coinMode71 == 1 or coinMode71 == 3:  # 0 = 매매중지 , 1 = >>>매도매수가능<<< , 2 = 매수만가능 , 3 = >>>매도만가능<<<
                    if op_mode71 == 1 or op_mode71 == 4:   # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                        print("")
                        print(f"[ 71. 매도시간 : {now}  |  코인명 : {coin71}  |  현재가 = ￦{price71}  |  MACD = ￦{macd71}  |  보유수량 = {krw_balance71}  |  평가금액 = ￦{bp71}  ||  매도평균금액 = ￦{sell_bpAve71} ]")

                        if bp71 > sell_bpAve61: # 보유금액이 평균가보다 높을때
                            # 매도할 코인 금액 = 코인보유금액 - 평균가
                            sell_krw_price71 = bp71 - sell_bpAve71

                            if sell_krw_price71 >= 10000:    # 매도할 금액이 ￦10,000 보다 높을때 매도
                                # 매도할 코인 갯수 = 매도할 코인 금액 - 현재가
                                sell_krw_balance71 = sell_krw_price71 / price71

                                # 보유코인 초과금액 매도시도
                                # 매도할 코인명 - krw_coin71, 매도할 코인수량 - sell_krw_balance71
                                upbit.sell_market_order(krw_coin71, sell_krw_balance71)

                                # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                op_mode71 = 2

                                print("평균 이상 금액 매도")
                                print(f"매도한금액 = ￦{sell_krw_price71}  |  매도한수량 = {sell_krw_balance71}  |  매수가능여부 - {op_mode71} - 매수가능-매도불가")
                                print("")
                            else:
                                # 코인 매도 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                op_mode71 = 2
                                ...
                                print("￦10,000 이하 금액 매도불가")
                                print(f"매수가능여부 - {op_mode71} - 매수가능-매도불가")
                                print("")
            ...
            # 코인별 금액 비율조정
            buy_bpAve69 = bpAve * bpPer69

            # MACD 조건문
            if macd69 >= 0:     # macd가 0보다 크거나 같을때는 매수
                # 매수가능금액 불러오기
                krw69 = upbit.get_balance("KRW")

                if coinMode69 == 1 or coinMode69 == 2:  # 0 = 매매중지 , 1 = >>>매도매수가능<<< , 2 = >>>매수만가능<<< , 3 = 매도만가능
                    if op_mode69 == 2 or op_mode69 == 3:   # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                        print("")
                        print(f"[ 69. 매수시간 : {now}  |  코인명 : {coin69}  |  현재가 = ￦{price69}  |  MACD = ￦{macd69}  |  보유수량 = {krw_balance69}  |  평가금액 = ￦{bp69}  ||  매수평균금액 = ￦{buy_bpAve69} ]")

                        if bp69 < buy_bpAve69: # 코인보유금액이 평균가보다 낮을때 매수시도
                            # 매수할 코인 금액 = 평균가 - 코인보유금액
                            buy_krw_price69 = buy_bpAve69 - bp69
                            # 매수할 코인 갯수 = 매수할 코인 금액 - 현재가
                            buy_krw_balance69 = buy_krw_price69 / price69

                            if krw69 >= buy_krw_price69: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price69 >= 10000:    # 매수가능금액이 최소주문가능금액인 ￦10,000원보다 높을때 매수시도

                                    # 매수할 코인명 - krw_coin69, 매수할 코인금액 - buy_krw_price69
                                    upbit.buy_market_order(krw_coin69, buy_krw_price69 * 0.9)

                                    # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                    op_mode69 = 1

                                    print("평균 이하 금액 매수")
                                    print(f"매수한금액 = ￦{buy_krw_price69}  |  매수한수량 = {buy_krw_balance69}  |  매수가능여부 - {op_mode69} - 매수불가-매도가능")
                                    print("")
                                    ...
                                    print("매수금액이 ￦10,000 미만이여서 매수금지")
                                    print(f"매수가능여부 - {op_mode69} - 매수불가-매도가능")
                                    print("")
                            else:   # 보유금액이 평균가와의 차이보다 적을때 매수
                                if krw69 >= 10000:    # 보유금액이 최소주문가능금액인 ￦10,000원보다 높을때 매수시도
                                    # 매수할 코인명 - krw_coin69, 매수할 코인금액 - krw69
                                    upbit.buy_market_order(krw_coin69, krw69 * 0.9)

                                    op_mode69 = 1

                                    print("보유금액보다 매수금액보다 적어서 매수금지")
                                    print(f"매수한금액 = ￦{krw69}  |  매수한수량 = {buy_krw_balance69}  |  매수가능여부 - {op_mode69} - 매수불가-매도가능")
                                    print("")
                                else:
                                    # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                    op_mode69 = 1
            ...
            # 코인별 금액 비율조정
            buy_bpAve70 = bpAve * bpPer70

            # MACD 조건문
            if macd70 >= 0:     # macd가 0보다 크거나 같을때는 매수
                # 매수가능금액 불러오기
                krw70 = upbit.get_balance("KRW")

                if coinMode70 == 1 or coinMode70 == 2:  # 0 = 매매중지 , 1 = >>>매도매수가능<<< , 2 = >>>매수만가능<<< , 3 = 매도만가능
                    if op_mode70 == 2 or op_mode70 == 3:   # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                        print("")
                        print(f"[ 70. 매수시간 : {now}  |  코인명 : {coin70}  |  현재가 = ￦{price70}  |  MACD = ￦{macd70}  |  보유수량 = {krw_balance70}  |  평가금액 = ￦{bp70}  ||  매수평균금액 = ￦{buy_bpAve70} ]")

                        if bp70 < buy_bpAve70: # 코인보유금액이 평균가보다 낮을때 매수시도
                            # 매수할 코인 금액 = 평균가 - 코인보유금액
                            buy_krw_price70 = buy_bpAve70 - bp70
                            # 매수할 코인 갯수 = 매수할 코인 금액 - 현재가
                            buy_krw_balance70 = buy_krw_price70 / price70

                            if krw70 >= buy_krw_price70: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price70 >= 10000:    # 매수가능금액이 최소주문가능금액인 ￦10,000원보다 높을때 매수시도

                                    # 매수할 코인명 - krw_coin70, 매수할 코인금액 - buy_krw_price70
                                    upbit.buy_market_order(krw_coin70, buy_krw_price70 * 0.9)

                                    # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                    op_mode70 = 1

                                    print("평균 이하 금액 매수")
                                    print(f"매수한금액 = ￦{buy_krw_price70}  |  매수한수량 = {buy_krw_balance70}  |  매수가능여부 - {op_mode70} - 매수불가-매도가능")
                                    print("")
                                    ...
                                    print("매수금액이 ￦10,000 미만이여서 매수금지")
                                    print(f"매수가능여부 - {op_mode70} - 매수불가-매도가능")
                                    print("")
                            else:   # 보유금액이 평균가와의 차이보다 적을때 매수
                                if krw70 >= 10000:    # 보유금액이 최소주문가능금액인 ￦10,000원보다 높을때 매수시도
                                    # 매수할 코인명 - krw_coin70, 매수할 코인금액 - krw70
                                    upbit.buy_market_order(krw_coin70, krw70 * 0.9)

                                    op_mode70 = 1

                                    print("보유금액보다 매수금액보다 적어서 매수금지")
                                    print(f"매수한금액 = ￦{krw70}  |  매수한수량 = {buy_krw_balance70}  |  매수가능여부 - {op_mode70} - 매수불가-매도가능")
                                    print("")
                                else:
                                    # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                    op_mode70 = 1
            ...
            # 코인별 금액 비율조정
            buy_bpAve71 = bpAve * bpPer71

            # MACD 조건문
            if macd71 >= 0:     # macd가 0보다 크거나 같을때는 매수
                # 매수가능금액 불러오기
                krw71 = upbit.get_balance("KRW")

                if coinMode71 == 1 or coinMode71 == 2:  # 0 = 매매중지 , 1 = >>>매도매수가능<<< , 2 = >>>매수만가능<<< , 3 = 매도만가능
                    if op_mode71 == 2 or op_mode71 == 3:   # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                        print("")
                        print(f"[ 71. 매수시간 : {now}  |  코인명 : {coin71}  |  현재가 = ￦{price71}  |  MACD = ￦{macd71}  |  보유수량 = {krw_balance71}  |  평가금액 = ￦{bp71}  ||  매수평균금액 = ￦{buy_bpAve71} ]")

                        if bp71 < buy_bpAve71: # 코인보유금액이 평균가보다 낮을때 매수시도
                            # 매수할 코인 금액 = 평균가 - 코인보유금액
                            buy_krw_price71 = buy_bpAve71 - bp71
                            # 매수할 코인 갯수 = 매수할 코인 금액 - 현재가
                            buy_krw_balance71 = buy_krw_price71 / price71

                            if krw71 >= buy_krw_price71: # 매수가능금액이 매수할금액보다 클때 매수시도
                                if buy_krw_price71 >= 10000:    # 매수가능금액이 최소주문가능금액인 ￦10,000원보다 높을때 매수시도

                                    # 매수할 코인명 - krw_coin71, 매수할 코인금액 - buy_krw_price71
                                    upbit.buy_market_order(krw_coin71, buy_krw_price71 * 0.9)

                                    # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                    op_mode71 = 1

                                    print("평균 이하 금액 매수")
                                    print(f"매수한금액 = ￦{buy_krw_price71}  |  매수한수량 = {buy_krw_balance71}  |  매수가능여부 - {op_mode71} - 매수불가-매도가능")
                                    print("")
                                    ...
                                    print("매수금액이 ￦10,000 미만이여서 매수금지")
                                    print(f"매수가능여부 - {op_mode71} - 매수불가-매도가능")
                                    print("")
                            else:   # 보유금액이 평균가와의 차이보다 적을때 매수
                                if krw71 >= 10000:    # 보유금액이 최소주문가능금액인 ￦10,000원보다 높을때 매수시도
                                    # 매수할 코인명 - krw_coin71, 매수할 코인금액 - krw71
                                    upbit.buy_market_order(krw_coin71, krw71 * 0.9)

                                    op_mode71 = 1

                                    print("보유금액보다 매수금액보다 적어서 매수금지")
                                    print(f"매수한금액 = ￦{krw71}  |  매수한수량 = {buy_krw_balance71}  |  매수가능여부 - {op_mode71} - 매수불가-매도가능")
                                    print("")
                                else:
                                    # 코인 매수 가능유무  -  1 = 평균이상-<매수불가>-매도가능 , 2 = 평균이하-<매수가능>-매도불가 , 3 = 평균이하-<매도불가>-매수가능 , 4 = 평균이상-<매도가능>-매수불가
                                    op_mode71 = 1
