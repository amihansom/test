...
coin8 = "LTC" # 라이트코인 - 크라켄 상장, 그레이스케일 상장
...
coin54 = "LSK" # 리스크 - 크라켄 상장
coinMode54 = 1 # 0 = 매매중지, 1 = 매도매수가능, 2 = 매수만가능, 3 = 매도만가능
coin55 = "KNC" # 카이버네트워크 - 크라켄 상장
...
while True:
    ...
    if now.hour == 1 or now.hour == 5 or now.hour == 9 or now.hour == 13 or now.hour == 17 or now.hour == 21:
        if now.minute == 0:
            ...
            bpAve6 = bp51 + bp52 + bp53 + bp54 + bp55

            bpAve = (bpAve1 + bpAve2 + bpAve3 + bpAve4 + bpAve5 + bpAve6 ) / 55
